...
export function AccountSection({ user }: { user: AccountUser }) {
  return (
    <SettingsSection
      ...
      description="Hirelix uses Google sign-in for every account. Manage your Google profile (password, 2FA, recovery) in your Google account settings."
    >
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Your account is linked to this Google identity. To change
                  password, security keys, or recovery options, visit your
