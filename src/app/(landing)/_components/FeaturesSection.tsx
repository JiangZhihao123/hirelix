...
export function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" data-growth-section="工作方式" className="scroll-mt-24 border-t border-slate-200 bg-slate-50 py-20 sm:py-28">
...
export function FeaturesSection() {
  ...
  return (
    <section id="features" data-growth-section="功能" className="scroll-mt-24 border-t border-slate-200 bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-6">
...
export function ResourcesSection({ onStart }: { onStart: () => void }) {
  ...
  return (
    <section id="resources" data-growth-section="资源" className="scroll-mt-24 border-t border-slate-200 bg-slate-50 py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-indigo-700">
