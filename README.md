...
```bash
SEARCH_SHORTLIST_ADVANCE_MATCH_SCORE_MIN=80
SEARCH_SHORTLIST_ADVANCE_RELEVANCE_MIN=75
SEARCH_SHORTLIST_ADVANCE_CAPABILITY_MIN=70
SEARCH_SHORTLIST_HOLD_MATCH_SCORE_MIN=80
SEARCH_SHORTLIST_HOLD_RELEVANCE_MIN=72
SEARCH_SHORTLIST_HOLD_CAPABILITY_MIN=72
SEARCH_SHORTLIST_HOLD_JOIN_LIKELIHOOD_MIN=55
```
