...
```bash
SEARCH_SHORTLIST_ADVANCE_MATCH_SCORE_MIN=66
SEARCH_SHORTLIST_ADVANCE_RELEVANCE_MIN=62
SEARCH_SHORTLIST_ADVANCE_CAPABILITY_MIN=62
SEARCH_SHORTLIST_HOLD_MATCH_SCORE_MIN=74
SEARCH_SHORTLIST_HOLD_RELEVANCE_MIN=68
SEARCH_SHORTLIST_HOLD_CAPABILITY_MIN=68
SEARCH_SHORTLIST_HOLD_JOIN_LIKELIHOOD_MIN=50
```
